...
def main():
    ...
    if cfg.gpu is not None:
        ...
        train_root_path = os.path.abspath(os.path.join('./dataset/', 'train_debug'))
    ...
    if cfg.gpu is not None:
        ...
        print('EAST <==> Prepare <==> Batch_size:{} <==> Begin'.format(cfg.train_batch_size_per_gpu))
